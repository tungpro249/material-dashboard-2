...
import MDSnackbarIconRoot from "components/ui/MDSnackbar/MDSnackbarIconRoot";

// Material Dashboard 2 React context
import { useMaterialUIController } from "context/materialContext";

function MDSnackbar({ color, icon, title, dateTime, content, close, bgWhite, ...rest }: any) {
  // @ts-ignore
